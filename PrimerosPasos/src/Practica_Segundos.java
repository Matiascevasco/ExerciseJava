...
public class Practica_Segundos {
	...
	public static void main(String[] args) {
		...
		do {
			...
			opciones = (JOptionPane.showInputDialog("Ingrese una opcion: Minutos, Horas " + ",Dias ,Semanas, Meses"));

		} while (opciones.equals(MN) == false && opciones.equals(HS) == false && opciones.equals(DI) == false
				&& opciones.equals(SE) == false && opciones.equals(ME) == false);
