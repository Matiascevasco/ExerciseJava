...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		/*
		 * Empleado director_comercial = new Jefatura("Juan Monzón", 55000, 2006 , 5,
		 * 29);
		 * 
		 * Comparable ejemplo = new Empleado("Elizabeth Grimes", 60000, 2007, 6, 21);
		 * 
		 * if( director_comercial instanceof Empleado) { //instanceof se puede usar en
		 * fases
		 * 
		...
		System.out.println(
				mis_empleados[3].decime_nombre() + " tiene un bonus de: " + mis_empleados[3].establece_bonus(200));
		...
		for (Empleado e : mis_empleados) {
			...
			System.out.println("Nombre " + e.decime_nombre() + " Sueldo " + e.decime_sueldo() + " Fecha de alta "
					+ e.decime_fecha_contrato());
		}
	}
