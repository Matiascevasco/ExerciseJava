...
public class Practica_tamaño {
	...
	public static void main(String[] args) {
		...
		do {
			...
			medidas = JOptionPane
					.showInputDialog("Introduzca una medida: Bits, Cuado/Nibble, Byte, Kilobyte, Megabyte, Gigabyte");

		} while (medidas.equals(BITS) == false && medidas.equals(NIBBLE) == false && medidas.equals(BYTE) == false
				&& medidas.equals(KB) == false && medidas.equals(MB) == false && medidas.equals(GB) == false);
		...
		do {
			...
			medidas2 = JOptionPane.showInputDialog(
					"Introduzca la medida de conversion: Bits, Cuado/Nibble, Byte, Kilobyte, Megabyte, Gigabyte");

		} while (medidas2.equals(BITS) == false && medidas2.equals(NIBBLE) == false && medidas2.equals(BYTE) == false
				&& medidas2.equals(KB) == false && medidas2.equals(MB) == false && medidas2.equals(GB) == false);
